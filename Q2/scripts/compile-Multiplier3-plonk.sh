...
circom Multiplier3.circom --r1cs --wasm --sym -o Multiplier3__plonk
...
snarkjs zkey export solidityverifier Multiplier3/circuit_0000.zkey ../Multiplier3Verifier__plonk.sol
